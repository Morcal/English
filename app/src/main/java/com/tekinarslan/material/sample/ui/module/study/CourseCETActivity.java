...
import com.tekinarslan.material.sample.ui.adapter.CetPagerAdapter;
 ...
 */
public class CourseCETActivity extends AppCompatActivity implements UniversalVideoView.VideoViewCallback, CourseListFragment.OnHeadlineSelectedListener {

    private static final String TAG = CourseCETActivity.class.getSimpleName();
    ...
    private CetPagerAdapter adapter;
    ...
    private void initView() {
        adapter = new CetPagerAdapter(getSupportFragmentManager(), this);
...
//                videoView.setVideoPath(audioUrl);
    ...
    private void saveData() {
        CourseCetEntity course = new CourseCetEntity();
        course.setId("cet401");
        course.setTitle("四级01");
        course.setAudioUrl("http://clips.vorwaerts-gmbh.de/big_buck_bunny.mp4");

        course.save(this, new SaveListener() {
            @Override
            public void onSuccess() {
                ViewUtils.showToastShort(CourseCETActivity.this, "插入成功");
                Logger.i("插入成功");
            }

            @Override
            public void onFailure(int i, String s) {
                ViewUtils.showToastShort(CourseCETActivity.this, "插入失败");
