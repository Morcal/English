 ...
 */
public class ShKAudioActivity extends AppCompatActivity {
    private static final String TAG = ShKAudioActivity.class.getSimpleName();
    @Bind(R.id.toolbar)
    Toolbar toolbar;
    @Bind(R.id.tv_share)
    TextView tvShare;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shuokaudio);
    ...
    private void iniData() {
        ...
        Logger.i("AUDIOURL" + audioUrl + " NAME:" + name + " DESC:" + desc + " TITLE:" + title + " AVATAR:" + image);
        tvTitle.setText(title);
        tvBody.setText(desc);
        nickName.setText(name);
        UIUtil.setAvatar(image, avatar);
...
//            @Override
//            public void onError() {
//                ViewUtils.showToastShort(ShKAudioActivity.this, getString(R.string.error));
