...
import com.tekinarslan.material.sample.ui.module.study.CourseListFragment;
 ...
 */
public class CetPagerAdapter extends FragmentPagerAdapter {
    final int PAGE_COUNT = 3;
    private String tabTitles[] = new String[]{"章节", "评论", "详情"};
    private Context context;

    public CetPagerAdapter(FragmentManager fm, Context context) {
        super(fm);
